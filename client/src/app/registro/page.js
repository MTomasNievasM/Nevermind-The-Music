      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="bg-white w-full max-w-md rounded-3xl shadow-xl border border-gray-100 p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-black text-gray-900 mb-2 tracking-tight">Únete al club</h1>
            <p className="text-gray-500 text-sm">Crea tu cuenta para guardar tus instrumentos favoritos y realizar compras.</p>
          </div>
